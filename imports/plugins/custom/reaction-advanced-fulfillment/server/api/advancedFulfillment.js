...
import { Shipstation } from "../../../reaction-shipstation/server/api";
...
AdvancedFulfillment.Shipstation.createOrder = function (orderId) {
  ...
  if (order) {
    ...
    const billingInfo = order.billing[0].address;
    ...
    shipTo.company = shippingInfo.company;
