...
Template.goCheckoutShippingOptions.onCreated(function () {
  this.autorun(() => {
    this.subscribe("Shipping");
  });
});

Template.goCheckoutShippingOptions.helpers({
...
//
Template.goCheckoutShippingOptions.events({
...
Template.goFlatRateCheckoutShipping.inheritsHelpersFrom("goCheckoutShippingOptions");
Template.goFlatRateCheckoutShipping.inheritsEventsFrom("goCheckoutShippingOptions");
